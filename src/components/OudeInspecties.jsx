        ...
        <table className='w-5/6  text-left text-gray-600 m-auto'>
            <thead className='font-semibold border-2 border-gray-300'>
                <tr>
                    ...
                    <th className='px-1 py-4 text-sm text-center border-2 border-gray-300'>Bew<wbr></wbr>erken</th>
                </tr>
            </thead>
            <tbody>
                ...
                <>
                    {inspecties.data.map((inspectie, index) => (
                        <tr key={index} className='odd:bg-white even:bg-slate-100 border-2 border-gray-300'>
                            <td className='px-3 py-4 border-2 border-gray-300'>{inspectie.id}</td>
                            <td className='px-3 py-4 border-2 border-gray-300'>{inspectie.datum}</td>
                            <td className='px-3 py-4 border-2 border-gray-300 xxs:text-[16px] text-xs'><Link to= {`/app/view-inspectie/${inspectie.id}`}>{inspectie.adres}</Link></td>
